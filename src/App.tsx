...
import { MedicinePage } from "@presentation/pages/MedicinePage"
import { RegistrationPage } from "@presentation/pages/RegisterPage";
...
export function App() {
  ...
  return <AppIntlProvider> {/* AppIntlProvider provides the functions to search the text after the provides string ids. */}
      ...
      <Routes>
        ...
        { <Route path={AppRoute.Medicine} element={<MedicinePage/>} /> }
        {/* <Route path={AppRoute.Supplier} element={<SupplierPage/>} /> */}
